...
type Controller interface {
	...
	// Update the service
	Update(spec *goharborv2.HarborCluster) (*CRStatus, error)

	// More...
}

type CRStatus struct {
	Condition  goharborv2.HarborClusterCondition `json:"condition"`
	Properties Properties                        `json:"properties"`
}

// New returns new CRStatus
func New(conditionType goharborv2.HarborClusterConditionType) *CRStatus {
	return &CRStatus{
		Condition: goharborv2.HarborClusterCondition{
