...
import (
	...
	"github.com/plotly/harbor-operator/pkg/cluster/controllers/cache"
	"github.com/plotly/harbor-operator/pkg/cluster/controllers/database"
	"github.com/plotly/harbor-operator/pkg/cluster/controllers/harbor"
	"github.com/plotly/harbor-operator/pkg/cluster/controllers/storage"
	minio "github.com/plotly/harbor-operator/pkg/cluster/controllers/storage/minio/apis/minio.min.io/v2"
