...
// +kubebuilder:rbac:groups=goharbor.io,resources=chartmuseums;cores;jobservices;notaryservers;notarysigners;portalsregitries;registrycontrollers,verbs=get;list;watch;create;update;patch;delete
