...
func (r *Reconciler) AddCoreLB(ctx context.Context, harbor *goharborv1alpha3.Harbor, core Core, portal Portal) (CoreLB, error) {
...
func (r *Reconciler) GetCoreLB(ctx context.Context, harbor *goharborv1alpha3.Harbor) *corev1.Service {
...
func (r *Reconciler) AddNotaryServerLB(ctx context.Context, harbor *goharborv1alpha3.Harbor, server NotaryServer) (NotaryServerLB, error) {
...
func (r *Reconciler) GetNotaryServerLB(ctx context.Context, harbor *goharborv1alpha3.Harbor) *corev1.Service {
...
func (r *Reconciler) AddNotarySignerLB(ctx context.Context, harbor *goharborv1alpha3.Harbor, signer NotarySigner) (NotarySignerLB, error) {
...
func (r *Reconciler) GetNotarySignerLB(ctx context.Context, harbor *goharborv1alpha3.Harbor) *corev1.Service {
	if harbor.Spec.Expose.Notary == nil || harbor.Spec.Expose.Notary.LoadBalancer == nil {
		return nil
	}
	...
	return &corev1.Service{
		...
		Spec: corev1.ServiceSpec{
			Ports: []corev1.ServicePort{{
				...
				Port:       goharborv1alpha3.NotarySignerAPIPort,
...
func (r *Reconciler) AddPortalLB(ctx context.Context, harbor *goharborv1alpha3.Harbor, portal Portal) (NotarySignerLB, error) {
...
func (r *Reconciler) GetPortalLB(ctx context.Context, harbor *goharborv1alpha3.Harbor) *corev1.Service {
