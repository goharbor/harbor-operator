...
func (r *Reconciler) AddNotaryServerLB(ctx context.Context, harbor *goharborv1alpha2.Harbor, server NotaryServer) (NotaryServerLB, error) {
...
func (r *Reconciler) GetNotaryServerLB(ctx context.Context, harbor *goharborv1alpha2.Harbor) *corev1.Service {
...
func (r *Reconciler) AddNotarySignerLB(ctx context.Context, harbor *goharborv1alpha2.Harbor, signer NotarySigner) (NotarySignerLB, error) {
...
func (r *Reconciler) GetNotarySignerLB(ctx context.Context, harbor *goharborv1alpha2.Harbor) *corev1.Service {
	if harbor.Spec.Expose.Notary == nil || harbor.Spec.Expose.Notary.LoadBalancer == nil {
		return nil
	}
...
func (r *Reconciler) AddPortalLB(ctx context.Context, harbor *goharborv1alpha2.Harbor, portal Portal) (NotarySignerLB, error) {
...
func (r *Reconciler) GetPortalLB(ctx context.Context, harbor *goharborv1alpha2.Harbor) *corev1.Service {
