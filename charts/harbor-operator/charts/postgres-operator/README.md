...
| configConnectionPooler.connection_pooler_image | string | `"registry.opensource.zalan.do/acid/pgbouncer:master-16"` |  |
...
| configGeneral.docker_image | string | `"registry.opensource.zalan.do/acid/spilo-13:2.0-p7"` |  |
...
| configKubernetes.spilo_allow_privilege_escalation | string | `"true"` |  |
...
| configLogicalBackup.logical_backup_docker_image | string | `"registry.opensource.zalan.do/acid/logical-backup:v1.6.3"` |  |
...
| configMajorVersionUpgrade.minimal_major_version | string | `"9.5"` |  |
| configMajorVersionUpgrade.target_major_version | string | `"13"` |  |
...
| configTeamsApi.enable_admin_role_for_users | string | `"true"` |  |
| configTeamsApi.enable_postgres_team_crd | string | `"false"` |  |
| configTeamsApi.enable_postgres_team_crd_superusers | string | `"false"` |  |
| configTeamsApi.enable_team_member_deprecation | string | `"false"` |  |
| configTeamsApi.enable_team_superuser | string | `"false"` |  |
| configTeamsApi.enable_teams_api | string | `"false"` |  |
| configTeamsApi.pam_role_name | string | `"zalandos"` |  |
| configTeamsApi.postgres_superuser_teams | string | `"postgres_superusers"` |  |
| configTeamsApi.protected_role_names | string | `"admin"` |  |
| configTeamsApi.role_deletion_suffix | string | `"_deleted"` |  |
| configTeamsApi.team_admin_role | string | `"admin"` |  |
| configTeamsApi.team_api_role_configuration | string | `"log_statement:all"` |  |
