...
// +kubebuilder:webhook:verbs=create;update,path=/validate-goharbor-io-v1alpha3-jobservice,mutating=false,failurePolicy=fail,groups=goharbor.io,resources=jobservices,versions=v1alpha3,name=vjobservice.kb.io,admissionReviewVersions={"v1beta1"},sideEffects=None
