...
// +kubebuilder:webhook:verbs=create;update,path=/validate-goharbor-io-v1alpha3-registry,mutating=false,failurePolicy=fail,groups=goharbor.io,resources=registries,versions=v1alpha3,name=vregistry.kb.io,admissionReviewVersions={"v1beta1"},sideEffects=None
