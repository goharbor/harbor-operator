...
// +kubebuilder:webhook:verbs=create;update,path=/validate-goharbor-io-v1alpha3-notarysigner,mutating=false,failurePolicy=fail,groups=goharbor.io,resources=notarysigners,versions=v1alpha3,name=vnotarysigner.kb.io,admissionReviewVersions={"v1beta1"},sideEffects=None
