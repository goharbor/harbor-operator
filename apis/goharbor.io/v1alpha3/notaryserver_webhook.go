...
// +kubebuilder:webhook:verbs=create;update,path=/validate-goharbor-io-v1alpha3-notaryserver,mutating=false,failurePolicy=fail,groups=goharbor.io,resources=notaryservers,versions=v1alpha3,name=vnotaryserver.kb.io,admissionReviewVersions={"v1beta1"},sideEffects=None
