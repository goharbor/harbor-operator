...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ErrMultipleExposeSpec) DeepCopyInto(out *ErrMultipleExposeSpec) {
	{
		in := &in
		*out = make(ErrMultipleExposeSpec, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ErrMultipleExposeSpec.
func (in ErrMultipleExposeSpec) DeepCopy() ErrMultipleExposeSpec {
	if in == nil {
		return nil
	}
	out := new(ErrMultipleExposeSpec)
	in.DeepCopyInto(out)
	return *out
}
